...
pub struct CMsgGCRoutingProtoBufHeader {
    // message fields
    dst_gcid_queue: ::std::option::Option<u64>,
    dst_gc_dir_index: ::std::option::Option<u32>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CMsgGCRoutingProtoBufHeader {
    ...
    pub fn get_dst_gcid_queue(&self) -> u64 {
    ...
    pub fn get_dst_gc_dir_index(&self) -> u32 {
...
impl ::protobuf::Message for CMsgGCRoutingProtoBufHeader {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.dst_gcid_queue = ::std::option::Option::Some(tmp);
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    self.dst_gc_dir_index = ::std::option::Option::Some(tmp);
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<CMsgGCRoutingProtoBufHeader>(
    ...
    fn default_instance() -> &'static CMsgGCRoutingProtoBufHeader {
        static instance: ::protobuf::rt::LazyV2<CMsgGCRoutingProtoBufHeader> = ::protobuf::rt::LazyV2::INIT;
        instance.get(CMsgGCRoutingProtoBufHeader::new)
    }
}

impl ::protobuf::Clear for CMsgGCRoutingProtoBufHeader {
    fn clear(&mut self) {
        self.dst_gcid_queue = ::std::option::Option::None;
        self.dst_gc_dir_index = ::std::option::Option::None;
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for CMsgGCRoutingProtoBufHeader {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub struct CMsgProtoBufHeader {
    ...
    debug_source: ::protobuf::SingularField<::std::string::String>,
    debug_source_string_index: ::std::option::Option<u32>,
    token_id: ::std::option::Option<u64>,
    pub routing_gc: ::protobuf::SingularPtrField<CMsgGCRoutingProtoBufHeader>,
    // message oneof groups
...
impl CMsgProtoBufHeader {
    ...
    pub fn get_debug_source(&self) -> &str {
    ...
    pub fn set_debug_source(&mut self, v: ::std::string::String) {
        self.debug_source = ::protobuf::SingularField::some(v);
    }
    ...
    pub fn get_debug_source_string_index(&self) -> u32 {
    ...
    pub fn get_routing_gc(&self) -> &CMsgGCRoutingProtoBufHeader {
        self.routing_gc.as_ref().unwrap_or_else(|| <CMsgGCRoutingProtoBufHeader as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn set_routing_gc(&mut self, v: CMsgGCRoutingProtoBufHeader) {
        self.routing_gc = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_routing_gc(&mut self) -> &mut CMsgGCRoutingProtoBufHeader {
        if self.routing_gc.is_none() {
            self.routing_gc.set_default();
        }
        self.routing_gc.as_mut().unwrap()
    }
...
impl ::protobuf::Message for CMsgProtoBufHeader {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                34 => {
                    ::protobuf::rt::read_singular_string_into(wire_type, is, &mut self.debug_source)?;
                },
                35 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_uint32()?;
                    self.debug_source_string_index = ::std::option::Option::Some(tmp);
                },
                36 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                37 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.routing_gc)?;
                },
                15 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.debug_source.as_ref() {
        ...
        if let Some(ref v) = self.routing_gc.as_ref() {
            let len = v.compute_size();
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<CMsgGCRoutingProtoBufHeader>>(
                "routing_gc",
...
pub struct CMsgAuthTicket {
    ...
    server_secret: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CMsgAuthTicket {
    ...
    pub fn get_server_secret(&self) -> &[u8] {
    ...
    pub fn set_server_secret(&mut self, v: ::std::vec::Vec<u8>) {
        self.server_secret = ::protobuf::SingularField::some(v);
    }
    ...
    pub fn mut_server_secret(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.server_secret.is_none() {
            self.server_secret.set_default();
        }
...
impl ::protobuf::Message for CMsgAuthTicket {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                8 => {
                    ::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.server_secret)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.server_secret.as_ref() {
...
pub struct CCDDBAppDetailCommon {
    ...
    app_type: ::std::option::Option<u32>,
    has_adult_content_sex: ::std::option::Option<bool>,
    has_adult_content_violence: ::std::option::Option<bool>,
...
impl CCDDBAppDetailCommon {
    ...
    pub fn get_has_adult_content_sex(&self) -> bool {
    ...
    pub fn get_has_adult_content_violence(&self) -> bool {
    ...
    pub fn get_content_descriptorids(&self) -> &[u32] {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                14 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.app_type = ::std::option::Option::Some(tmp);
                },
                15 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_bool()?;
                    self.has_adult_content_sex = ::std::option::Option::Some(tmp);
                },
                16 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_bool()?;
                    self.has_adult_content_violence = ::std::option::Option::Some(tmp);
                },
                17 => {
                    ::protobuf::rt::read_repeated_uint32_into(wire_type, is, &mut self.content_descriptorids)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct CMsgAppRights {
    ...
    edit_store_display_content: ::std::option::Option<bool>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CMsgAppRights {
    ...
    pub fn get_edit_store_display_content(&self) -> bool {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                17 => {
                    ...
                    let tmp = is.read_bool()?;
                    self.edit_store_display_content = ::std::option::Option::Some(tmp);
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct CCommunity_ClanAnnouncementInfo {
    ...
    ban_check_result: ::std::option::Option<EBanContentCheckResult>,
...
impl CCommunity_ClanAnnouncementInfo {
    ...
    pub fn get_ban_check_result(&self) -> EBanContentCheckResult {
        self.ban_check_result.unwrap_or(EBanContentCheckResult::k_EBanContentCheckResult_NotScanned)
    }
    ...
    pub fn set_ban_check_result(&mut self, v: EBanContentCheckResult) {
        self.ban_check_result = ::std::option::Option::Some(v);
    }
...
impl ::protobuf::Message for CCommunity_ClanAnnouncementInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                16 => {
                    ::protobuf::rt::read_proto2_enum_with_unknown_fields_into(wire_type, is, &mut self.ban_check_result, 16, &mut self.unknown_fields)?
                },
                17 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeEnum<EBanContentCheckResult>>(
                "ban_check_result",
...
pub struct CClanEventData {
    ...
    build_id: ::std::option::Option<u32>,
    build_branch: ::protobuf::SingularField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CClanEventData {
    ...
    pub fn get_build_branch(&self) -> &str {
    ...
    pub fn set_build_branch(&mut self, v: ::std::string::String) {
        self.build_branch = ::protobuf::SingularField::some(v);
    }
...
impl ::protobuf::Message for CClanEventData {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                30 => {
                    ::protobuf::rt::read_singular_string_into(wire_type, is, &mut self.build_branch)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.build_branch.as_ref() {
...
impl ::protobuf::Message for CMsgKeyValuePair {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<CMsgKeyValuePair>(
                "CMsgKeyValuePair",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static CMsgKeyValuePair {
        static instance: ::protobuf::rt::LazyV2<CMsgKeyValuePair> = ::protobuf::rt::LazyV2::INIT;
        instance.get(CMsgKeyValuePair::new)
    }
}

impl ::protobuf::Clear for CMsgKeyValuePair {
    fn clear(&mut self) {
        self.name.clear();
        self.value.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for CMsgKeyValuePair {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub struct CMsgKeyValueSet {
    // message fields
    pub pairs: ::protobuf::RepeatedField<CMsgKeyValuePair>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CMsgKeyValueSet {
    ...
    pub fn get_pairs(&self) -> &[CMsgKeyValuePair] {
        &self.pairs
    }
    ...
    // Param is passed by value, moved
    pub fn set_pairs(&mut self, v: ::protobuf::RepeatedField<CMsgKeyValuePair>) {
        self.pairs = v;
    }

    // Mutable pointer to the field.
    pub fn mut_pairs(&mut self) -> &mut ::protobuf::RepeatedField<CMsgKeyValuePair> {
        &mut self.pairs
    }

    // Take field
    pub fn take_pairs(&mut self) -> ::protobuf::RepeatedField<CMsgKeyValuePair> {
...
impl ::protobuf::Message for CMsgKeyValueSet {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<CMsgKeyValuePair>>(
                "pairs",
                |m: &CMsgKeyValueSet| { &m.pairs },
                |m: &mut CMsgKeyValueSet| { &mut m.pairs },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<CMsgKeyValueSet>(
                "CMsgKeyValueSet",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static CMsgKeyValueSet {
        static instance: ::protobuf::rt::LazyV2<CMsgKeyValueSet> = ::protobuf::rt::LazyV2::INIT;
        instance.get(CMsgKeyValueSet::new)
    }
}

impl ::protobuf::Clear for CMsgKeyValueSet {
    fn clear(&mut self) {
        self.pairs.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for CMsgKeyValueSet {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub mod exts {
    ...
    pub const allow_field_named_steam_id: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::FieldOptions, ::protobuf::types::ProtobufTypeBool> = ::protobuf::ext::ExtFieldOptional { field_number: 50024, phantom: ::std::marker::PhantomData };
}
