...
pub struct CMsgClientHeartBeat {
    // message fields
    send_reply: ::std::option::Option<bool>,
    // special fields
...
impl CMsgClientHeartBeat {
    ...
    pub fn get_send_reply(&self) -> bool {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.send_reply = ::std::option::Option::Some(tmp);
                },
                _ => {
...
pub struct CMsgClientLogon {
    ...
    is_steam_deck: ::std::option::Option<bool>,
    access_token: ::protobuf::SingularField<::std::string::String>,
    is_chrome_os: ::std::option::Option<bool>,
    is_tesla: ::std::option::Option<bool>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl CMsgClientLogon {
    ...
    pub fn get_is_steam_deck(&self) -> bool {
    ...
    pub fn get_is_chrome_os(&self) -> bool {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                107 => {
                    ...
                    let tmp = is.read_bool()?;
                    self.is_steam_deck = ::std::option::Option::Some(tmp);
                },
                108 => {
                ...
                109 => {
                    ...
                    let tmp = is.read_bool()?;
                    self.is_chrome_os = ::std::option::Option::Some(tmp);
                },
                110 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_bool()?;
                    self.is_tesla = ::std::option::Option::Some(tmp);
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct CMsgClientLogonResponse {
    ...
    legacy_out_of_game_heartbeat_seconds: ::std::option::Option<i32>,
    heartbeat_seconds: ::std::option::Option<i32>,
    deprecated_public_ip: ::std::option::Option<u32>,
...
impl CMsgClientLogonResponse {
    ...
    pub fn get_legacy_out_of_game_heartbeat_seconds(&self) -> i32 {
    ...
    pub fn get_heartbeat_seconds(&self) -> i32 {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    let tmp = is.read_int32()?;
                    self.legacy_out_of_game_heartbeat_seconds = ::std::option::Option::Some(tmp);
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = is.read_int32()?;
                    self.heartbeat_seconds = ::std::option::Option::Some(tmp);
                },
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
